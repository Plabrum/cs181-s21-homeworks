...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        This model would classify the star as a \textbf{giant}. The classifier doesn't give an indication as to how trustworthy the result is as the new result is clearly in the giant decision boundary but seems to be from the dwarf stars.
        \item
    \end{enumerate}
\end{enumerate}
